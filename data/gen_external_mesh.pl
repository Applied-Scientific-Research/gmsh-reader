#!/usr/bin/perl
#
# generate a structured mesh for external flow over a rectangular prism for Omega2D (Hybrid)

my $length = 1.0;	# here, length and width are of the solid body
my $height = 1.0;
my $meshthick = 0.08;	# and thickness extends into the flow, away from the body
my $outerdt = 0.01;
my $innerdt = $outerdt * 0.5;
my $dl = $outerdt;
...
my $templ = "external_structured_template.geo";

// -----------------------------------------------------------------------------
//
//  Structured mesh around solid rectangle
//
// -----------------------------------------------------------------------------
...
Line(7) = {9,5};
Line(8) = {6,10};
Transfinite Curve{1,2,5,6} = LEN/cell + 1;
Transfinite Curve{3,4,7,8} = HGT/cell + 1;
...
Line(23) = {14,13};
Line(24) = {14,10};
Transfinite Curve{9,10,12,13,14,16,17,18,20,21,22,24} = NPTS Using Progression 1.0/PROG;
Transfinite Curve{11,15,19,23} = NPTS Using Progression PROG;
...
Physical Curve("wall") = {2,8,6,4};
Physical Curve("open") = {9,1,15,17,5,23,13,3,19,21,7,11};
